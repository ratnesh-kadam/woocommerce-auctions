...
Tags: wordpress auctions, woocommerce auctions, simple wordpress auctions, auctions, auction plugin, wordpress auction plugin, woocommerce auction plugin, simple auction, wpgenie auction, wpgenie
...
== Description ==
WooCommerce Auction Software is a plugin for a woocommerce. Since WooCommerce is popular we decided that it would be neat to extend it with auction features. 
