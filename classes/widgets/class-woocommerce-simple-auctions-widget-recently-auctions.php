...
class WC_SA_Widget_Recently_Viewed_Auction extends WP_Widget
{
    ...
    function __construct() 
    {
        ...
        $this->woo_widget_description = __('Display a list of recently viewed auctions.', 'wc_auction_software');
        $this->woo_widget_idbase = 'woocommerce_recently_viewed_auctions';
        $this->woo_widget_name = __('WooCommerce Recently Viewed Auctions', 'wc_auction_software');
    ...
    function widget($args, $instance) 
    {
        ...
        $title = apply_filters('widget_title', empty( $instance['title'] ) ? __('Recently viewed auctions', 'wc_auction_software') : $instance['title'], $instance, $this->id_base);
