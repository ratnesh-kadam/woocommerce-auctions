...
class WC_SA_Widget_Recent_Auction extends WP_Widget
{
    ...
    function __construct() 
    {
        ...
        $this->woo_widget_description = __('Display a list of your most recent auctions on your site.', 'woocommerce');
        $this->woo_widget_idbase = 'woocommerce_recent_auctions';
        $this->woo_widget_name = __('WooCommerce Recent Auctions', 'woocommerce');
    ...
    function widget($args, $instance) 
    {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('New Auctions', 'woocommerce') : $instance['title'], $instance, $this->id_base);
    ...
    function form( $instance ) 
    {
     ...
     <p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of auctions to show:', 'woocommerce'); ?></label>
