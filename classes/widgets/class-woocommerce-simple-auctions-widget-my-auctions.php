...
class WC_SA_Widget_My_Auction extends WP_Widget
{
    ...
    function __construct() 
    {
        ...
        $this->woo_widget_description = __('Display a list of auctions user participate.', 'wc_simple_auctions');
        $this->woo_widget_idbase = 'woocommerce_my_auctions';
        $this->woo_widget_name = __('WooCommerce My Auction', 'wc_simple_auctions');
    ...
    function widget($args, $instance) 
    {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('My Auctions', 'wc_simple_auctions') : $instance['title'], $instance, $this->id_base);
